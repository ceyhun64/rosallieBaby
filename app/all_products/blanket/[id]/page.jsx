...
export async function generateMetadata({ params }) {
  try {
    ...
    const description = product.description
      ...
      : "Premium personalized baby blanket. Made with 100% organic muslin cotton.";
    ...
    return {
      ...
      description: "Discover our premium handcrafted personalized baby blankets.",
    };
  }
}
...
export default function BlanketDetailPage() {
  return (
    <main>
      <Topbar />
      <Navbar />
      <ProductDetail category="blanket" />
      <Footer />
    </main>
  );
}
