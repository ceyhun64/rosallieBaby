      ...
      <div className="relative overflow-hidden pt-24 py-32 px-4 md:px-8">
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          ...
          <div className="space-y-4">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/20 backdrop-blur-md rounded-lg border border-white/30 shadow-lg shadow-white/20">
            ...
            <p className="text-xl text-white/90 max-w-2xl font-light drop-shadow-sm">
              Explore our premium selection of children-themed outfits for kids
              and professionals.
            </p>
          </div>
        </div>
