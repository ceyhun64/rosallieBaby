...
async function getProducts() {
  const res = await fetch(
    `${process.env.NEXT_PUBLIC_BASE_URL}/api/products/category/blanket`,
    { cache: "no-store" }
  );
    ...
    <div className="min-h-screen">
      ...
      <div className="relative overflow-hidden pt-24 py-32 px-4 md:px-8">
        ...
        <div className="absolute inset-0">
          <Image
            src="/categoryBanners/blanketbanner.webp"
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          ...
          <div className="space-y-4">
            ...
            <p className="text-xl text-white/90 max-w-2xl font-light drop-shadow-sm">
              Wrap your little one in love with our handcrafted, personalized
              muslin blankets
            </p>
          </div>
        </div>
